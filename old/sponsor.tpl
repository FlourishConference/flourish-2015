...
{include file="header.tpl" title="Sponsorship Information"}
			...
			<div class="essay">
				...
				<p>Started in 2006 by a group of computer hobbyists at the University of Illinois at Chicago, the Flourish! Conference was designed to fill a void in the open source community. For the past four years, the conference has attracted students, enthusiasts and the business community alike and has allowed them to connect, share ideas and discuss recent developments. This year, an even larger group of volunteers from all over the community has taken up the mantle to make the conference our best yet. </p>
				
				<p>With your contribution, we can afford to create an amazing conference and, once again, bring together the vibrant Chicago open source community. As a sponsor, you'll be able to introduce yourself to the talent of the community and become a part of it.</p>
				
				<p>We've included a guide of what you can expect with your donation along with this document. If you have questions or concerns, please contact the Flourish Organizers, by email at <a href="mailto:info@flourishconf.com?Subject=Flourish%202014%20Sponsorship%20Information">info@flourishconf.com</a>.</p>
				
				<h2>What do I get with my donation?</h2>
				We're glad you asked.  First of all, you will receive the gratitude and goodwill of 

				the open source community, UIC students, and that warm fuzzy feeling that you've done something really really good.  But, of course, it doesn't stop there as we offer the following perks based on the amount of your generous donation.
